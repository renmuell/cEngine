  ...
  cEngine.extend('filter', {
    ...
    create: function(config) {
      ...
      var filter = {
        ...
        postStep: function(context, width, height){
          ...
          for (i = 0; i < filter.list.length; i++) {
            ...
            if (filter.list[i].Shader) {
              ...
              imageData = filter.Convolve(
                            context,
                            imageData,
                            width,
                            filter.list[i].Convolver.data,
                            filter.list[i].Convolver.divisor,
                            filter.list[i].Convolver.offset);
            }
          }

          filter.setImageData(context, imageData);
        },
        Shader: function(imageData, filter, factor){
        ...
        Convolve: function(context, imageData, canvasWidth, matrix, divisor, offset){
          ...
          for (var i = 0; i < len; i++) {
            ...
            res = 0;
            var these = [
              oldData[i - w * 4 - 4] || oldData[i],
              oldData[i - w * 4]     || oldData[i],
              oldData[i - w * 4 + 4] || oldData[i],
              oldData[i - 4]         || oldData[i],
              oldData[i],
              oldData[i + 4]         || oldData[i],
              oldData[i + w * 4 - 4] || oldData[i],
              oldData[i + w * 4]     || oldData[i],
        ...
        getImageData: function(context, width, height){
            return context.getImageData(0, 0, width, height);
        },
        setImageData: function(context, data){
    ...
    Shader: {
      ...
      rgbToBrg: function(r, g, b) {
        return [b, r, g, 255];
      },
      rgbToRbg: function(r, g, b) {
        return [r, b, g, 255];
      },
      rgbToGbr: function(r, g, b) {
        return [g, b, r, 255];
      },
      rgbToGrB: function(r, g, b) {
        return [g, r ,b, 255];
      },
      rgbToBgr: function(r, g, b) {
        return [b, g, r, 255];
      },
      transparent: function(r, g, b, a, factor) { // factor: "value (0-255)"
        return [r, g, b, factor];
      },
      gradient: function(r, g, b, a, factor, i, l) { // factor: "value (0-255)"
      ...
      sepia: function(r, g, b) {
        var avg = 0.3  * r + 0.59 * g + 0.11 * b;
        return [avg + 100, avg + 50, avg, 255];
      },
      sepia2: function(r, g, b) {
        return [
      ...
      gammaCorrect: function(r, g, b, a, factor) { // factor: 'value(2-10), decimal OK'
          return [
      ...
      negative: function(r, g, b) {
        return [255 - r, 255 - g, 255 - b, 255];
      },
      noGreen: function(r, g, b) {
        return [r, 0, b, 255];
      },
      maxGreen: function(r, g, b) {
        return [r, 255, b, 255];
      },
      onlyGreen: function(r, g) {
        return [0, g, 0, 255];
      },
      maxAllButGreen: function(r, g) {
        return [255, g, 255, 255];
      },
      brightness: function(r, g, b, a, factor) { // factor: '(0-255)'
        return [r + factor, g + factor, b + factor, 255];
      },
      noise: function(r, g, b, a, factor) { //   factor: '(0 - 500+)'
        if (r != 0 && g != 0 && b != 0 && a != 0) {
      ...
      randomClear: function(r, g, b, a, factor){
        if (r != 0 && g != 0 && b != 0 && a != 0) {
